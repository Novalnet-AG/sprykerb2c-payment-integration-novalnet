...
class PaymentManager implements PaymentManagerInterface
{
    ...
    {
		$customerObj = $orderTransfer->getCustomer();
        $customerData = [
            'first_name' 	=> $orderTransfer->getBillingAddress()->getFirstName(),
            'last_name' 	=> $orderTransfer->getBillingAddress()->getLastName(),
            'email' 		=> !empty($customerObj) ? $customerObj->getEmail() : $orderTransfer->getEmail(),
            'tel'			=> $orderTransfer->getBillingAddress()->getPhone(),
            'customer_no' 	=> !empty($customerObj) ? $customerObj->getIdCustomer() : 'guest',
    ...
    protected function setTransactionData(OrderTransfer $orderTransfer, &$requestData)
    {
        ...
        $transactionData = [
            ...
            'system_name' 		=> 'Spryker-B2C',
            'system_version' 	=> '202204.0-NN1.2.1',
        ];
    ...
    {
        $requestData['custom'] = [
            'lang' 		=> strtoupper($this->standardParameter->getLanguage()),
            'input1' 	=> 'locale',
